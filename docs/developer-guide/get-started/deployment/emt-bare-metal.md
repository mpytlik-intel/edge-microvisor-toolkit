...
Below you will learn how to deploy Edge Microvisor Toolkit on bare metal using ISO or
RAW images.

## Requirements

- An OS image, depending on the version of Edge Microvisor Toolkit:
...
- A USB flash drive (min. 8GB)
- Access to the target machine
- Optional: A monitor and a keyboard, or BMC/iDRAC/iKVM access
...
- On Linux OS
  ...
  3. Then, safely remove the USB drive.
...
- On Windows OS
  ...
  to just selecting ISO image and target USB drive. If you decide to use Rufus, follow
